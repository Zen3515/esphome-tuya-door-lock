...
TuyaDoorLockCover = tuya_ns.class_("TuyaDoorLockCover", cover.Cover, cg.Component)

TuyaDoorLockCoverRestoreMode = tuya_ns.enum("TuyaDoorLockCoverRestoreMode")
RESTORE_MODES = {
    "NO_RESTORE": TuyaDoorLockCoverRestoreMode.COVER_NO_RESTORE,
    "RESTORE": TuyaDoorLockCoverRestoreMode.COVER_RESTORE,
    "RESTORE_AND_CALL": TuyaDoorLockCoverRestoreMode.COVER_RESTORE_AND_CALL,
}
...
CONFIG_SCHEMA = cv.All(
    cover.COVER_SCHEMA.extend(
        {
            cv.GenerateID(CONF_OUTPUT_ID): cv.declare_id(TuyaDoorLockCover),
