...
enum TuyaDoorLockCoverRestoreMode {
  COVER_NO_RESTORE,
  COVER_RESTORE,
  COVER_RESTORE_AND_CALL,
};

class TuyaDoorLockCover : public cover::Cover, public Component {
 public:
  void setup() override;
  ...
  void set_restore_mode(TuyaDoorLockCoverRestoreMode restore_mode) { restore_mode_ = restore_mode; }
 ...
 protected:
  ...
  TuyaDoorLockCoverRestoreMode restore_mode_{};
