...
enum TuyaDoorLockColorType {
  RGB,
  HSV,
  RGBHSV,
};

class TuyaDoorLockLight : public Component, public light::LightOutput {
 public:
  void setup() override;
  ...
  void set_color_type(TuyaDoorLockColorType color_type) { this->color_type_ = color_type; }
 ...
 protected:
  ...
  optional<TuyaDoorLockColorType> color_type_{};
