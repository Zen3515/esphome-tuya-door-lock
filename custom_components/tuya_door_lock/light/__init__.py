...
TuyaDoorLockColorType = tuya_ns.enum("TuyaDoorLockColorType")

COLOR_TYPES = {
    "RGB": TuyaDoorLockColorType.RGB,
    "HSV": TuyaDoorLockColorType.HSV,
    "RGBHSV": TuyaDoorLockColorType.RGBHSV,
}

TuyaDoorLockLight = tuya_ns.class_("TuyaDoorLockLight", light.LightOutput, cg.Component)
...
CONFIG_SCHEMA = cv.All(
    light.BRIGHTNESS_ONLY_LIGHT_SCHEMA.extend(
        {
            cv.GenerateID(CONF_OUTPUT_ID): cv.declare_id(TuyaDoorLockLight),
            ...
            # The TuyaDoorLock MCU handles transitions and gamma correction on its own.
